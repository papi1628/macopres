    ...
    <div class="space-y-5">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5"
                ...
                <p class="text-[10px] text-slate-400 mt-1.5">Arrivée après 8h15</p>
            </div>
                    ...
                    <tbody>
                        @forelse ($premieresArrivees as $index => $pointage)
                            <tr class="border-t border-slate-50 hover:bg-slate-50/60 transition-colors">
                                ...
                                <td class="px-4 py-2.5 font-mono text-[10px] text-slate-600">{{ $pointage->arrivee }}</td>
                                <td class="px-4 py-2.5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
                ...
                <div class="flex flex-wrap gap-x-4 gap-y-1 mt-3">
                    @foreach ([['Présents',$presents,'#3B6D11'],['Retards',$retards,'#854F0B'],['Absents',$absents,'#A32D2D'],['Congés',$conges,'#185FA5']] as [$label,$val,$color])
                ...
                <table class="w-full text-[11px]">
                    <thead>
                        <tr style="background:#f8fafc">
                            ...
                            <th class="text-left px-4 py-2 text-[9px] font-semibold text-slate-400 uppercase tracking-wider">Statut</th>
                            <th class="text-left px-4 py-2 text-[9px] font-semibold text-slate-400 uppercase tracking-wider">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($absentsAujourdhui as $employe)
                            <tr class="border-t border-slate-50 hover:bg-slate-50/60 transition-colors">
                                ...
                                <td class="px-4 py-2.5">
                                    <a href="#"
                                       class="text-[10px] font-semibold transition-colors hover:underline"
                                       style="color:#185FA5">Justifier</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" class="px-4 py-8 text-center text-[12px] text-slate-400">
