...
<body>
    <div class="page">
        <div class="menu-res">
            ...
            <nav class="menu-item-group-res">
                    <a class="menu-item-res" href="dashboard_pdg.php">
                    ...
                    <a href="gestion_utilisateurs.php" class="menu-item-res">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                            <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
                        </svg>
                        
                    </a>
                    <a class="menu-item-res" href="gestion_role.php">
                    ...
                    <a class="menu-item-employe-res" href="gestion_employe.php">
            ...
            <div class="middle">
                <div class="before-table">
                        ...
                        <form method="get" class="search-box-form">
                            <input class="barre_de_recherche" type="text" name="search" placeholder="Rechercher un utilisateur." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
                            <button type="submit" >
                ...
                if (isset($_GET["search"]) && $_GET["search"] != "") {
                    ...
                    $req1 = mysqli_prepare($con, "SELECT * FROM employe WHERE nom LIKE ?  OR prenom LIKE ? OR dateNaissance LIKE ? OR sexe LIKE ? OR tel LIKE ? OR adresse LIKE ? OR departement LIKE ? OR code LIKE ? OR dateEmbauche LIKE ?");
                    mysqli_stmt_bind_param($req1, "sssssssss", $search, $search, $search, $search, $search, $search, $search, $search, $search);
                }
